...
export const Landing = () => {
  return (
    <section className='flex flex-col md:flex-row items-center justify-center max-w-7xl mx-auto md:py-12'>
      {/* Left Image */}
      <div className='md:w-1/2 order-2 md:order-1 '>
        <img
          src='https://picsum.photos/500/500?random=2'
          alt='VR User'
          className='relative z-10 rounded-full place-self-end size-80'
          loading='eager'
          data-aos='fade-right'
        />
